...
@Component({
  selector: 'app-cvs-latest-guidelines-of-hypertension',
  templateUrl: './cvs-latest-guidelines-of-hypertension.page.html',
  styleUrls: ['./cvs-latest-guidelines-of-hypertension.page.scss'],
})
export class CvsLatestGuidelinesOfHypertensionPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/cvs-latest-guidelines-of-hypertension',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
