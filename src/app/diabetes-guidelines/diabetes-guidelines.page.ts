...
@Component({
  selector: 'app-diabetes-guidelines',
  templateUrl: './diabetes-guidelines.page.html',
  styleUrls: ['./diabetes-guidelines.page.scss'],
})
export class DiabetesGuidelinesPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/diabetes-guidelines',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
