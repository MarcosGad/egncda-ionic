...
@Component({
  selector: 'app-respiratory-guidelines',
  templateUrl: './respiratory-guidelines.page.html',
  styleUrls: ['./respiratory-guidelines.page.scss'],
})
export class RespiratoryGuidelinesPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/respiratory-guidelines',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
