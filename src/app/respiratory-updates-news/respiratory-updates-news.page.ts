...
@Component({
  selector: 'app-respiratory-updates-news',
  templateUrl: './respiratory-updates-news.page.html',
  styleUrls: ['./respiratory-updates-news.page.scss'],
})
export class RespiratoryUpdatesNewsPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/respiratory-updates-news',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
