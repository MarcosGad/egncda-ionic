...
@Component({
  selector: 'app-cvs-hypertension',
  templateUrl: './cvs-hypertension.page.html',
  styleUrls: ['./cvs-hypertension.page.scss'],
})
export class CvsHypertensionPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/cvs-hypertension',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
