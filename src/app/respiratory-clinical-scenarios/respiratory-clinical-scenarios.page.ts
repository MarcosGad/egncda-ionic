...
@Component({
  selector: 'app-respiratory-clinical-scenarios',
  templateUrl: './respiratory-clinical-scenarios.page.html',
  styleUrls: ['./respiratory-clinical-scenarios.page.scss'],
})
export class RespiratoryClinicalScenariosPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/respiratory-clinical-scenarios',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
