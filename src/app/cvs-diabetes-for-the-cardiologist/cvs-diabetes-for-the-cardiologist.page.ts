...
@Component({
  selector: 'app-cvs-diabetes-for-the-cardiologist',
  templateUrl: './cvs-diabetes-for-the-cardiologist.page.html',
  styleUrls: ['./cvs-diabetes-for-the-cardiologist.page.scss'],
})
export class CvsDiabetesForTheCardiologistPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/cvs-diabetes-for-the-cardiologist',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
