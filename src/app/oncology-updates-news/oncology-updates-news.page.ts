...
@Component({
  selector: 'app-oncology-updates-news',
  templateUrl: './oncology-updates-news.page.html',
  styleUrls: ['./oncology-updates-news.page.scss'],
})
export class OncologyUpdatesNewsPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/oncology-updates-news',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
