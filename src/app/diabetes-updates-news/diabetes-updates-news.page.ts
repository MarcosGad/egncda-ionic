...
@Component({
  selector: 'app-diabetes-updates-news',
  templateUrl: './diabetes-updates-news.page.html',
  styleUrls: ['./diabetes-updates-news.page.scss'],
})
export class DiabetesUpdatesNewsPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/diabetes-updates-news',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
