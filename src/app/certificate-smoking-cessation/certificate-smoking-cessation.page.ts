...
@Component({
  selector: 'app-certificate-smoking-cessation',
  templateUrl: './certificate-smoking-cessation.page.html',
  styleUrls: ['./certificate-smoking-cessation.page.scss'],
})
export class CertificateSmokingCessationPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/certificate-smoking-cessation',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
