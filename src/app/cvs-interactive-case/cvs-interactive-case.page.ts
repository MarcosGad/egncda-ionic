...
@Component({
  selector: 'app-cvs-interactive-case',
  templateUrl: './cvs-interactive-case.page.html',
  styleUrls: ['./cvs-interactive-case.page.scss'],
})
export class CvsInteractiveCasePage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/cvs-interactive-case',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
