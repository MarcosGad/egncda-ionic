...
@Component({
  selector: 'app-certificate-exam',
  templateUrl: './certificate-exam.page.html',
  styleUrls: ['./certificate-exam.page.scss'],
})
export class CertificateExamPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/miscellaneous-exam',{headers})
       .subscribe(res=>{
        let data = res;
