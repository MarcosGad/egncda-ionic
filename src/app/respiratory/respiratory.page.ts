...
@Component({
  ...
  templateUrl: './respiratory.page.html',
  styleUrls: ['./respiratory.page.scss'],
})
export class RespiratoryPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/respiratory',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
