...
@Component({
  selector: 'app-cvs-smoking-and-heart-diseases',
  templateUrl: './cvs-smoking-and-heart-diseases.page.html',
  styleUrls: ['./cvs-smoking-and-heart-diseases.page.scss'],
})
export class CvsSmokingAndHeartDiseasesPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/cvs-smoking-and-heart-diseases',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
