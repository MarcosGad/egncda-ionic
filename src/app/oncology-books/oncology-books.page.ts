...
@Component({
  selector: 'app-oncology-books',
  templateUrl: './oncology-books.page.html',
  styleUrls: ['./oncology-books.page.scss'],
})
export class OncologyBooksPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/oncolcgy-books',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
