...
@Component({
  selector: 'app-oncology-guidelines',
  templateUrl: './oncology-guidelines.page.html',
  styleUrls: ['./oncology-guidelines.page.scss'],
})
export class OncologyGuidelinesPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/oncology-guidelines',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
