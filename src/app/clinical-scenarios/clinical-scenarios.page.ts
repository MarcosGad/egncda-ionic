...
@Component({
  selector: 'app-clinical-scenarios',
  templateUrl: './clinical-scenarios.page.html',
  styleUrls: ['./clinical-scenarios.page.scss'],
})
export class ClinicalScenariosPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/clinical-scenarios',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
