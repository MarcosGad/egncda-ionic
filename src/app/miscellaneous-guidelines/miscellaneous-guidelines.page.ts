...
@Component({
  selector: 'app-miscellaneous-guidelines',
  templateUrl: './miscellaneous-guidelines.page.html',
  styleUrls: ['./miscellaneous-guidelines.page.scss'],
})
export class MiscellaneousGuidelinesPage implements OnInit {
