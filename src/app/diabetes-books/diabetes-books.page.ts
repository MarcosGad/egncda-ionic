...
@Component({
  selector: 'app-diabetes-books',
  templateUrl: './diabetes-books.page.html',
  styleUrls: ['./diabetes-books.page.scss'],
})
export class DiabetesBooksPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/diabetes-books',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
