...
@Component({
  selector: 'app-miscellaneous-exam',
  templateUrl: './miscellaneous-exam.page.html',
  styleUrls: ['./miscellaneous-exam.page.scss'],
})
export class MiscellaneousExamPage implements OnInit {
