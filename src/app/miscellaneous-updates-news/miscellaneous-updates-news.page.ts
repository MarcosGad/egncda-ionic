...
@Component({
  selector: 'app-miscellaneous-updates-news',
  templateUrl: './miscellaneous-updates-news.page.html',
  styleUrls: ['./miscellaneous-updates-news.page.scss'],
})
export class MiscellaneousUpdatesNewsPage implements OnInit {
