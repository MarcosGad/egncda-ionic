...
@Component({
  selector: 'app-miscellaneous-clinical-scenarios',
  templateUrl: './miscellaneous-clinical-scenarios.page.html',
  styleUrls: ['./miscellaneous-clinical-scenarios.page.scss'],
})
export class MiscellaneousClinicalScenariosPage implements OnInit {
