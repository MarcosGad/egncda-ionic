...
@Component({
  selector: 'app-cvs-drug-therapy-overview',
  templateUrl: './cvs-drug-therapy-overview.page.html',
  styleUrls: ['./cvs-drug-therapy-overview.page.scss'],
})
export class CvsDrugTherapyOverviewPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/cvs-drug-therapy-overview',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
