...
@Component({
  selector: 'app-cvs-risk-assessment-in-hypertension',
  templateUrl: './cvs-risk-assessment-in-hypertension.page.html',
  styleUrls: ['./cvs-risk-assessment-in-hypertension.page.scss'],
})
export class CvsRiskAssessmentInHypertensionPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/cvs-risk-assessment-in-hypertension',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
