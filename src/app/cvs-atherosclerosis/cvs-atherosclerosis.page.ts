...
@Component({
  selector: 'app-cvs-atherosclerosis',
  templateUrl: './cvs-atherosclerosis.page.html',
  styleUrls: ['./cvs-atherosclerosis.page.scss'],
})
export class CvsAtherosclerosisPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/cvs-atherosclerosis',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
