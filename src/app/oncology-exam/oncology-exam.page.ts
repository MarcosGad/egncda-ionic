...
@Component({
  selector: 'app-oncology-exam',
  templateUrl: './oncology-exam.page.html',
  styleUrls: ['./oncology-exam.page.scss'],
})
export class OncologyExamPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/oncology-exam',{headers})
       .subscribe(res=>{
        let data = res;
