...
@Component({
  ...
  templateUrl: './drug-index.page.html',
  styleUrls: ['./drug-index.page.scss'],
})
export class DrugIndexPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/drug-index',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
