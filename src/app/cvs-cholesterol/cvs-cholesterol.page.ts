...
@Component({
  selector: 'app-cvs-cholesterol',
  templateUrl: './cvs-cholesterol.page.html',
  styleUrls: ['./cvs-cholesterol.page.scss'],
})
export class CvsCholesterolPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/cvs-cholesterol',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
