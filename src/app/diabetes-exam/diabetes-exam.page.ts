...
@Component({
  selector: 'app-diabetes-exam',
  templateUrl: './diabetes-exam.page.html',
  styleUrls: ['./diabetes-exam.page.scss'],
})
export class DiabetesExamPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/diabetes-exam',{headers})
       .subscribe(res=>{
        let data = res;
