...
@Component({
  selector: 'app-respiratory-books',
  templateUrl: './respiratory-books.page.html',
  styleUrls: ['./respiratory-books.page.scss'],
})
export class RespiratoryBooksPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/respiratory-books',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
