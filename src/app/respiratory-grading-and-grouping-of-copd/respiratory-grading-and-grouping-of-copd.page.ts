...
@Component({
  selector: 'app-respiratory-grading-and-grouping-of-copd',
  templateUrl: './respiratory-grading-and-grouping-of-copd.page.html',
  styleUrls: ['./respiratory-grading-and-grouping-of-copd.page.scss'],
})
export class RespiratoryGradingAndGroupingOfCopdPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/respiratory-grading-and-grouping-of-copd',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
