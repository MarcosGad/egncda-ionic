...
@Component({
  ...
  templateUrl: './updates-news.page.html',
  styleUrls: ['./updates-news.page.scss'],
})
export class UpdatesNewsPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/updates-news',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
