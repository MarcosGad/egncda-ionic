...
@Component({
  selector: 'app-certificate-books',
  templateUrl: './certificate-books.page.html',
  styleUrls: ['./certificate-books.page.scss'],
})
export class CertificateBooksPage implements OnInit {
