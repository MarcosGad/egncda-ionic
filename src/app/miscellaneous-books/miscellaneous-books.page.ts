...
@Component({
  selector: 'app-miscellaneous-books',
  templateUrl: './miscellaneous-books.page.html',
  styleUrls: ['./miscellaneous-books.page.scss'],
})
export class MiscellaneousBooksPage implements OnInit {
  ...
  getData(){
    return new Promise((resolve, reject) => { 
      this.storage.get('token').then((value) => {
       ...
       this.http.get(this.url+'api/miscellaneous-books',{headers})
       .subscribe(res=>{
        let data = res;
        this.page = data;
