...
@Component({
  selector: 'app-cvs-books',
  templateUrl: './cvs-books.page.html',
  styleUrls: ['./cvs-books.page.scss'],
})
export class CvsBooksPage implements OnInit {
    ...
    getData(){
      return new Promise((resolve, reject) => { 
        this.storage.get('token').then((value) => {
         ...
         this.http.get(this.url+'api/cvs-books',{headers})
         .subscribe(res=>{
          let data = res;
          this.page = data;
